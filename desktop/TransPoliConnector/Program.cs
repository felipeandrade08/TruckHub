...
namespace TransPoliConnector
{
    internal static class Program
    {
        ...
        {
            const int Zone2 = 40, Zone3 = 500, Zone4 = 700, Zone5 = 1500, Zone9 = 2300, JobIncomeOffset = 4000, SpecialEventsOffset = 4300;
            ...
            var cargoDamage = ReadFloat(reader, TruckFloat + (130 * 4));
            ...
            var onJob = ReadBool(reader, SpecialEventsOffset + 0); var jobFinished = ReadBool(reader, SpecialEventsOffset + 1); var jobCancelled = ReadBool(reader, SpecialEventsOffset + 2); var jobDelivered = ReadBool(reader, SpecialEventsOffset + 3); var refuel = ReadBool(reader, SpecialEventsOffset + 8);
    ...
    {
        public bool Connected { get; set; } public bool Updated { get; set; } public ulong Timestamp { get; set; } public string Game { get; set; } public bool GamePaused { get; set; } public string TruckBrand { get; set; } public string TruckModel { get; set; } public string TruckId { get; set; } public string LicensePlate { get; set; } public bool EngineEnabled { get; set; } public bool ElectricEnabled { get; set; } public bool CargoLoaded { get; set; } public bool SpecialJob { get; set; } public bool OnJob { get; set; } public bool JobFinished { get; set; } public bool JobCancelled { get; set; } public bool JobDelivered { get; set; } public bool RefuelActive { get; set; }
