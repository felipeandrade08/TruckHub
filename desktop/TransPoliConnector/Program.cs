...
namespace TransPoliConnector
{
    internal static class Program
    {
        ...
        private static TelemetrySnapshot ReadSnapshot(BinaryReader reader)
        {
            ...
            var cargoDamage = ReadFloat(reader, TruckFloat + (130 * 4)); var refuelAmount = ReadFloat(reader, TruckFloat + (132 * 4));
            ...
            var onJob = ReadBool(reader, SpecialEventsOffset + 0); var jobFinished = ReadBool(reader, SpecialEventsOffset + 1); var jobCancelled = ReadBool(reader, SpecialEventsOffset + 2); var jobDelivered = ReadBool(reader, SpecialEventsOffset + 3); var refuel = ReadBool(reader, SpecialEventsOffset + 8); var refuelPayed = ReadBool(reader, SpecialEventsOffset + 9);
