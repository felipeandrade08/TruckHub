...
namespace TransPoliConnector
{
    internal static class Program
    {
        ...
        private static TelemetrySnapshot ReadSnapshot(BinaryReader reader)
        {
            ...
            var truckBrand = ReadString(reader, Zone9 + 64); var truckId = ReadString(reader, Zone9 + 128); var truckName = ReadString(reader, Zone9 + 192); var cargo = ReadString(reader, Zone9 + 320); var destinationCity = ReadString(reader, Zone9 + 448); var destinationCompany = ReadString(reader, Zone9 + 576); var sourceCity = ReadString(reader, Zone9 + 704); var sourceCompany = ReadString(reader, Zone9 + 832); var licensePlate = ReadString(reader, Zone9 + 912); var jobMarket = ReadString(reader, Zone9 + 1104); var fineOffence = ReadString(reader, Zone9 + 1156); var cargoMass = ReadFloat(reader, Zone4 + 4 + (11 * 4)); var gameName = game == 1 ? "ETS2" : game == 2 ? "ATS" : "Unknown";
    ...
    {
        public bool Connected { get; set; } public bool Updated { get; set; } public ulong Timestamp { get; set; }
