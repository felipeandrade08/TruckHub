...
public sealed class TrailerTelemetry
{
    ...
    {
        if (data is null) { GpsMapSourceText.Text="UNAVAILABLE"; GpsCoordinatesText.Text="GPS aguardando telemetria"; GpsWorldText.Text="— / —"; GpsHeadingText.Text="—°"; GpsCalibrationText.Text="climate.sii não carregado"; GpsStatusText.Text="GPS visual pronto • aguardando posição do Connector"; return; }
        try {
            ...
            GpsStatusText.Text=nav.PositionValid?(nav.MapSource=="ETS2_CALIBRATED"?"GPS calibrado • posição geográfica disponível":"GPS ETS2_WORLD • aguardando validação climate.sii"):"GPS sem posição válida • Connector aguardando dados";
        ...
        } catch { GpsStatusText.Text="GPS temporariamente indisponível • telemetria preservada"; }
    }
