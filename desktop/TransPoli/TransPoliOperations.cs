...
public partial class MainWindow
{
    ...
    private void SaveOperations()
    {
        try
        {
            ...
            {
                Refuelings = _refuelings, Stops = _stops, Occurrences = _occurrences, Documents = _documents, PoliPassRecords = _poliPassRecords
...
public sealed class OperationsState{public List<RefuelingRecord>? Refuelings{get;set;}public List<StopRecord>? Stops{get;set;}public List<OccurrenceRecord>? Occurrences{get;set;}public List<DocumentRecord>? Documents{get;set;}public List<PoliPassRecord>? PoliPassRecords{get;set;}}
