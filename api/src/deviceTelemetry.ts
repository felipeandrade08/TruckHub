    ...
    try {
      ...
      await sql`
        ...
        ON CONFLICT (user_id) DO UPDATE SET
          ...
          battery_voltage=EXCLUDED.battery_voltage,odometer_km=EXCLUDED.odometer_km,air_pressure=EXCLUDED.air_pressure,brake_temperature=EXCLUDED.brake_temperature,
