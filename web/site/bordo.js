/* TransPoli • TruckHub — Computador de bordo (web).
...
function renderAlerts() {
  ...
  if (!state.connected) {
    alert.textContent = 'Telemetria offline • abra o TruckHub no PC com o ETS2';
  ...
  $('[data-status]').textContent = state.connected
    ...
    : 'TruckHub pronto. Inicie o Connector junto com o ETS2.';
}
