(() => {
  ...
  async function render() {
    ...
    if (!finished.length) {
      content.innerHTML = '<div class="tacho-grid"><div class="detail-item"><span>VIAGENS COM TACÓGRAFO</span><strong>0</strong></div><div class="detail-item"><span>DISTÂNCIA</span><strong>0 km</strong></div><div class="detail-item"><span>TEMPO DE DIREÇÃO</span><strong>0h 00min</strong></div><div class="detail-item"><span>STATUS</span><strong>AGUARDANDO VIAGEM</strong></div></div><p class="tacho-note">Inicie uma viagem com o ETS2 conectado. O TransPoli calculará direção, paradas, pausas, distância e consumo a partir da telemetria.</p>';
      return;
    }
    ...
    </div><p class="tacho-note">Dados calculados pelas amostras reais da telemetria do ETS2. O TransPoli separa automaticamente direção, parada e jogo pausado.</p>`;
  }
